...
public:
	...
	Barva(int r, int g, int b)
	{
		SetColor(r, g, b, 255);
	}
	Barva(int r, int g, int b, int a)
	{
		SetColor(r, g, b, a);
	}
	Barva(int a)
	...
	bool operator == (const Barva &rhs) const
	{
	...
	Barva &operator=(const Barva &rhs)
	{
		SetRawColor(rhs.GetRawColor());
		return *this;
	}

	Barva &operator=(float color[3])
	{
		_color[0] = color[0] / 255.f;
		_color[1] = color[1] / 255.f;
		_color[2] = color[2] / 255.f;
		_color[3] = 255.f;
		return *this;
	}
	float Hue() const
	...
	static Barva FromHSB(float hue, float saturation, float brightness)
	{
